...
#Install VMware Tools in silence Mode (Reboot Supressed)
e:\setup64.exe /s /v "/qb REBOOT=R"
# sleep time 60 Seconds
Start-Sleep -Seconds 30
#IP Address and DNS Settings
New-NetIPAddress -InterfaceAlias 'ethernet0' -IPAddress '10.65.160.43' -PrefixLength 24 -DefaultGateway '10.65.160.1'
Set-DnsClientServerAddress -InterfaceAlias 'ethernet0' -ServerAddress ("10.65.160.2","10.65.160.3")
#enable RDP
